...
if (isset($_GET['errors'])) {
    ...
    foreach ($errors_code as $error) {
        ...
        if ($error == "ridnotfound") {
            array_push($errors_message, "Tour user not found");
        }
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td><input class="inp" id="wtype" type="text" name="wtype" required></td>
                </tr>
                <tr>
                    <td><label for="rid"> TourGuide ID</label></td>
                    <td><input class="inp" id="rid" type="number" name="rid" required></td>
                </tr>
                <!-- <tr>
