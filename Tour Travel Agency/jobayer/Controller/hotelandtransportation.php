...
<head>
  ...
  <script type="text/javascript" src="../View/js/hotelandtransportation.js"></script>
    <link rel="stylesheet" href="../View/css/hotelandtransportation.css">
</head>
<body >
    ...
    include "../Model/dbHotelandtransportationAdd.php";
