...
<script src="../abid/View/js/view.js"></script>
<link rel="stylesheet" href="../abid/View/css/view.css"></link>
</head>
<body id="viewbody">
...
include "../abid/Model/dbViewDel.php";
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="GET" name = "view" onsubmit="return isValid()";>
...
<p align="right"><a href="../abid/View/Tschema.php">Go back</p></a><br>
