...
<head>
	<meta charset="utf-8">
	<title></title>
   <script src="../abid/View/js/registration.js"></script>
   <link rel="stylesheet" href="../abid/View/css/registration.css"></link>
</head>
<body>
...
<?php
   ...
   include "../abid/Model/dbRegistrationInsert.php";
...
<a href="../abid/Controller/login.php">,<p style = "text-align: right;">Go Back</p></a>
