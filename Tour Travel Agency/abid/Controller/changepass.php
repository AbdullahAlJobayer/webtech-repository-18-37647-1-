...
<link rel="stylesheet" href="../abid/View/css/changepass.css"></link>
<script src="../abid/View/js/changepass.js"></script>
</head>
<body>
<?php


include "../abid/Model/dbUpdateChangePass.php";
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name = "changepass" onsubmit="return isValid()";>
 ...
 <br>
<p align="right"><a href="../abid/View/TourGuide.php">Back</a></p>
<br>
