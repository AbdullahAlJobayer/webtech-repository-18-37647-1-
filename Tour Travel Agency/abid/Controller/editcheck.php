<?php include "../abid/Model/dbChecklistUpdate.php";?>
...
<head>
    ...
    <link rel="stylesheet" href="../abid/View/css/editcheck.css"></link>
    <script src="editcheck.js"></script>
</head>
<body>
...
{
$customeridErr = " &nbsp &nbsp &nbsp *Please fill in field ";
$flag = true;
}
...
if(!$flag)
{
	...
	$spot3 = input($_POST["spot3"]);
     ...
     $res = editchecklist($scheduledplace, $scheduledtime, $recommendedtrans, $customernumber, $recommendedcuisine, $spot1, $spot2,  $spot3, $customerid);
...
?>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name = "editchecklist" onsubmit="return isValid()";>
        <br><br>

     <p id="editcheck"><b>EDIT CHECKLISTS:</p>
...
<br><br>
    ...
    <p align="right"><a href="../abid/View/checklist.php">Back</ap>
