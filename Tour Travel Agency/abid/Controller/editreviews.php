<?php include "../abid/Model/dbUpdateReviews.php";?>
...
<head>
	...
	<meta charset="utf-8">
	<title>Review</title>
  <link rel="stylesheet" href="../abid/View/css/editreviews.css"></link>
  <script src="../abid/View/js/editreviews.js"></script>
</head>
...
if(!$flag) 
    {
      ...
      $feedback = input($_POST["feedback"]);
       ...
       $res = editRev($coop, $coop2, $rate, $rate2, $behave, $behave2,  $feedback, $customerid);
        if($res) {
        $successfulMessage = "Sucessfully Edited.";
        }
        else {
...
?>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name = "editRev" onsubmit="return isValid()";>

    <br><br>
	<h2 id="h2feedback"> FEEDBACK:</h2>
	<br>
  <div id="customer">
  ...
  <span style="color: red"><?php echo $customeridErr; ?> </span> <br><br>
   ...
   <span id="coopErr" style="color:red;"></span>
   ...
   <span id="coop2Err" style="color:red;"></span>
   ...
   <label for="behave">1.Was the customer well behaved?</label>
    <span id="behaveErr" style="color:red;"></span>
   ...
   <span id="behave2Err" style="color:red;"></span>
   ...
   <label for="rate">1.On a scale of 1-5, what is your overall rating?</label>
    <span id="rateErr" style="color:red;"></span>
   ...
   <label for="coop">2.How much will you rate his/her behavior? </label>
    <span id="rate2Err" style="color:red;"></span>
  ...
  <fieldset id="feedfs2">
    ...
    <br><br>
    <textarea id="feedbackta" name="feedback"></textarea>
    ...
    <p align="right"><a href="../abid/View/reviews.php">Back</ap>
