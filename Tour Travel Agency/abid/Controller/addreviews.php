<?php 
  ...
  include "../abid/Model/dbInsertReviews.php";
...
<head>
	...
	<meta charset="utf-8">
	<title>Review</title>
  <link rel="stylesheet" href="../abid/View/css/addreviews.css"></link>
  <script src="../abid/View/js/addreviews.js"></script>
</head>
...
?>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name = "addingrev" onsubmit="return isValid()";>
    <br><rb></rb>
