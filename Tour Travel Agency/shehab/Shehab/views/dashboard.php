<?php
    include("../controls/dashboard-controls.php");
...
<div class="main-content">
        ...
        <button class="btn" onclick="updateManager()">Update</button>
        <button class="btn" onclick="deleteManager()">Delete Account</button>
        <a href="logout.php"><button class="btn">Logout</button></a>
        <a href="../../"><button class="btn">Go Back</button></a>
</div>

<script src="../public/scripts/dashboard.js?v=<?= time(); ?>"></script>
