...
<head>
	...
	<script src="../view/js/updateContact.js"></script>
</head>
<body>
	...
	include '../model/updateContatctdb.php';
	$result = get();
	?>
	<?php
	...
	?>
	<div class="form-div" >
	<form  action="../controller/updateContactAction.php" method = "POST" name="form" onsubmit="ajax(this);return false;">
