...
<head>
	...
	<script src="../view/js/allUmra.js"></script>
</head>
<body>
<?php
session_start();
...
<?php
	...
	<form  action="../controller/showUmraAgenAction.php" method = "GET" name="form" onsubmit="ajax(this);return false;">
		<fieldset>
